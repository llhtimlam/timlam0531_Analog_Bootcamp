...
N 200 190 280 190 {lab=VSS}
N 0 190 0 210 {lab=VSS}
N -0 -300 -0 -280 {lab=VDD}
N -240 190 -0 190 {lab=VSS}
N -240 90 -240 190 {lab=VSS}
N -200 120 -200 190 {lab=VSS}
N 200 120 200 190 {lab=VSS}
N 280 90 280 190 {lab=VSS}
N -0 170 -0 190 {lab=VSS}
N -30 -230 -20 -230 {lab=VSS}
N -30 -230 -30 190 {lab=VSS}
N -30 140 -20 140 {lab=VSS}
N -30 -120 80 -120 {lab=VSS}
...
C {devices/ipin.sym} 0 210 3 0 {name=VSS lab=VSS}
...
spiceprefix=X
mult=1}
C {sky130_fd_pr/res_high_po.sym} 0 140 0 0 {name=R3
W=1
L=1
model=res_high_po
spiceprefix=X
