...
N 110 -100 130 -100 {lab=#net1}
N 40 -100 50 -100 {lab=#net2}
N 40 -140 40 -100 {lab=#net2}
N -120 -140 40 -140 {lab=#net2}
N -120 -180 -120 -90 {lab=#net2}
N 40 -210 40 -140 {lab=#net2}
N 40 -210 160 -210 {lab=#net2}
...
N -0 -200 0 90 {lab=VSS}
N -200 20 -200 60 {lab=#net3}
N -120 -30 -120 20 {lab=#net3}
N -280 -30 -280 20 {lab=#net3}
N -280 20 -120 20 {lab=#net3}
N -280 -180 -280 -90 {lab=#net4}
N -240 -210 -160 -210 {lab=#net4}
N -280 -140 -200 -140 {lab=#net4}
N -200 -210 -200 -140 {lab=#net4}
...
C {devices/vdd.sym} 0 -280 0 1 {name=l1 lab=VDD}
C {devices/gnd.sym} 0 160 0 0 {name=l2 lab=VSS}
C {sky130_fd_pr/res_generic_li.sym} 0 -230 0 0 {name=R2
W=1
L=1
